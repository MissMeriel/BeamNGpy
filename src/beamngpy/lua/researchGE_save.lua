...
M.handleOpenLidar = function(msg)
  ...
  -- log('I', 'research.LIDAR....')
  -- error occurs here
  local lidar = research.LIDAR(vid, offset, direction, vRes, vAngle, rps, hz, angle, maxDist)
  -- tried so far:
  -- local lidar = Engine.Lidar(vid, offset, direction, vRes, vAngle, rps, hz, angle, maxDist)
  -- local lidar = M.sensors.Lidar(vid, offset, direction, vRes, vAngle, rps, hz, angle, maxDist)
